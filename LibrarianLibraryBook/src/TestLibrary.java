public class TestLibrary {
	...
	public static void main(String[] args) {
		...
		System.out.println("Showing all available books:");
		theGuyWhoKnowsAlot.findMeAvailableBooks();
		System.out.println();
		System.out.println("Showing Book 3:");
		theGuyWhoKnowsAlot.findMeBook("Book3");
		System.out.println();
		System.out.println("Showing books written by Ruth:");
		...
		System.out.println();
		System.out.println("Trying to rent Book19");
		System.out.println(theGuyWhoKnowsAlot.rentBook("Book19"));
		theGuyWhoKnowsAlot.findMeBook("Book19");
